    ...
    <div class="container-fluid" x-data="poForm">
        ...
        @if (!$hasItemsToOrder)
            <div class="alert alert-warning d-flex justify-content-between align-items-center">
                ...
                <form id="markNotRequiredForm" action="{{ route('purchasing.spbs.mark-not-required', $spb) }}"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <table class="table table-sm">
                            ...
                            <tr>
                                <td>Estimasi Pakai</td>
                                @if ($spb->estimasi_pakai)
                                    <td>: {{ $spb->estimasi_pakai->format('d/m/Y') }}</td>
                                @else
                                    <td>: <span class="text-muted">Tidak ditentukan</span></td>
                                @endif
                            </tr>
                        </table>
                    </div>
            ...
            Alpine.data('poForm', () => ({
                ...
                calculateTotal() {
                    ...
                    for (let id in this.items) {
                        this.items[id].total = this.items[id].quantity * (parseFloat(this.items[id]
                            .unit_price) || 0);
